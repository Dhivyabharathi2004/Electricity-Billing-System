...
public class Project  extends JFrame implements ActionListener{
    ...
    Project(String atype,String meter){
        ...
        JMenuItem updateinformation = new JMenuItem("Update Informaton");
        ...
        JMenuItem viewinformation = new JMenuItem("View Informaton");
        ...
        generatebill .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));
        utility.add(notepad); 
        ...
        generatebill .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if (msg.equals("New Customer")){
            ...
            new CalculateBill();
        }else if (msg.equals("View Informaton")){
            new ViewInformation(meter);
        }else if (msg.equals("Update Informaton")){
